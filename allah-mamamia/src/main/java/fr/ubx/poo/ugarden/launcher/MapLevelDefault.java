...
public class MapLevelDefault extends MapLevel {
    ...
    private final MapEntity[][] level1 = {
            ...
            {Grass, Grass, Grass, PoisonedApple, Grass, Grass, Grass, Grass, Carrots, Carrots, Carrots, Carrots, Bee, Grass, Grass, Grass, Princess, DoorNextClosed},
            {Grass, Tree, Grass, Tree, Grass, Grass, Key, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass, Grass}
    };
